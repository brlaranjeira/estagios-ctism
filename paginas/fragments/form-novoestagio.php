...
<form id="form-novo-estagio" method="post" action="novoestagio.php">
    ...
    <div class="row">
        <div class="form-group col-md-6 col-xs-12">
            ...
            <input type="date" placeholder="dd/mm/aaaa" name="dtini" id="dtini" class="form-control">
        </div>
        <div class="form-group col-md-6 col-xs-12">
            <label for="dtfim">Data de Fim</label>
            <input type="date" placeholder="dd/mm/aaaa" name="dtfim" id="dtfim" class="form-control">
        </div>
    </div>
